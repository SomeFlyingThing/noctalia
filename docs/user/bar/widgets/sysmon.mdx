...
| `network_speed_decimal_places` | int | `1` | Number of decimal places for compact `net_rx`/`net_tx` values, from `0` to `3` |
...
network_speed_decimal_places = 2  # show values such as "1.23M"
```
